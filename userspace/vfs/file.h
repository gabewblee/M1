...
/**
 * file_read - Reads up to @count bytes into @buffer at the file position.
...
/**
 * file_write - Writes up to @count bytes from @buffer at the file position.
...
/**
 * file_seek - Repositions @file, storing the new offset in @result.
...
/**
 * file_readdir - Emits the next directory entry of @file into @entry.
