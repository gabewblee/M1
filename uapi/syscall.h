...
#define SYS_ipc_send             0u  /* Syscall 0:  Sends an IPC packet                       */
#define SYS_ipc_recv             1u  /* Syscall 1:  Receives an IPC packet                    */
#define SYS_ipc_call             2u  /* Syscall 2:  Sends an IPC packet and waits for a reply */
#define SYS_ipc_reply            3u  /* Syscall 3:  Replies to an IPC packet                  */
