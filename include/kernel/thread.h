...
typedef struct thread_ctrl_blk_t {
    ...
    virt_addr_t         esp;        /* Saved stack pointer             */
...
/**
 * thread_get_self - Returns the currently running thread.
...
/**
 * thread_create - Creates and readies a new thread in @task.
...
/**
 * kthread_init - Initializes the bootstrap thread for the
