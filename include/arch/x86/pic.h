...
#define ICW1_ICW4	    0x01     /* ICW4 follows ICW3                 */
#define ICW1_SINGLE	    0x02     /* Disable cascade mode              */
#define ICW1_INTERVAL4	0x04     /* Four-byte call interval           */
#define ICW1_LEVEL	    0x08     /* Level-triggered IRQ mode          */
#define ICW1_INIT	    0x10     /* Begin initialization              */

#define ICW4_8086	    0x01     /* 8086/88 interrupt mode            */
#define ICW4_AUTO	    0x02     /* Automatic EOI                     */
#define ICW4_BUF_SLAVE	0x08     /* Buffered slave mode               */
#define ICW4_BUF_MASTER	0x0C     /* Buffered master mode              */
#define ICW4_SFNM	    0x10     /* Special fully nested mode         */

#define CASCADE_IRQ     2        /* Slave cascade input               */

#define PIC_READ_IRR    0x0a     /* Select interrupt-request register */
