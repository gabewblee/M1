...
#define PFN_TO_PHYS(x)     ((x) << 12)                                          /* Converts a page frame number to a physical address           */
#define PHYS_TO_PFN(x)     ((x) >> 12)                                          /* Converts a physical address to a page frame number           */
