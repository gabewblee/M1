...
/**
 * vga_enable_cursor - Enable the hardware text cursor
...
/**
 * vga_disable_cursor - Disable the hardware text cursor
 */
void __cold vga_disable_cursor(void);

/**
 * vga_print_hex - Print a hexadecimal number at the current cursor position
...
/**
 * vga_print_decimal - Print a decimal number at the current cursor position
 * @num: The number to print
 * @fcolor: The foreground color of the number
 * @bcolor: The background color of the number
 */
...
/**
 * vga_print_char - Print a character at the current cursor position
...
/**
 * vga_print_string - Print a string at the current cursor position
